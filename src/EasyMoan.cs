        ...
        public void Update()
        {
            try
            {
                ...
                if (facialExpressionsOn.val && morphChanging && currentMorph != null)
                {
                    ...
                    {
                        currentMorph.SetValue((morphTime / morphActivateTime) * morphPower);
                        morphHoldOscVal = 0;
                    }
                    else if (morphTime < morphActivateTime + morphHoldTime)
                    {
                        ...
                        currentMorph.SetValue((1.0f - Mathf.Sin(morphHoldOscVal * 3.5f) * 0.07f) * morphPower);
                    }
                    ...
                    else
                    {
                        ...
                        currentMorph.SetValue(morphDeactivateVal * morphPower);
                    }
                }
